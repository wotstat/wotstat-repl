...
- `*-setup.exe` — установщик с ярлыками и удалением через системные настройки. Используйте его, если в системе отсутствует Microsoft Edge WebView2 или вам удобнее обычная установка.
