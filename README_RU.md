...
В [последнем релизе](https://github.com/wotstat/wotstat-repl/releases/latest) доступны два варианта для Windows:

- `wotstat-repl.exe` — готовое приложение без установки. На обычной, не урезанной Windows 10/11 больше ничего не требуется: скачайте файл и запустите его.
- `wotstat-repl_<версия>_x64-setup.exe` — установщик с ярлыками и удалением через системные настройки. Используйте его, если в системе отсутствует Microsoft Edge WebView2 или вам удобнее обычная установка.
